...
Route::middleware('auth:api')->get('/program/all/location', 'ProgramController@allWithLocation');
Route::middleware('auth:api')->get('/program/all/users', 'ProgramController@allWithUsers');
